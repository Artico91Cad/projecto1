            ...
            <div class="panel-body">
                <form:form id="employeeRegisterForm" cssClass="form-horizontal" modelAttribute="employee" method="post" action="saveEmployee">
                    ...
                    <div class="form-group">
                        <div class="control-label col-xs-3"> <form:label path="name" >Nombre</form:label> </div>
                        <div class="col-xs-6">
                    ...
                    <div class="form-group">
                        <form:label path="age" cssClass="control-label col-xs-3">Edad</form:label>
                        <div class="col-xs-6">
                    ...
                    <div class="form-group">
                        <div class="control-label col-xs-3"><form:label path="salary">Salario</form:label></div>
                        <div class="col-xs-6">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-xs-4">
                                <input type="submit" id="saveEmployee" class="btn btn-primary" value="Guardar" onclick="return submitEmployeeForm();"/>
                            </div>
                            <div class="col-xs-4">
                            </div>
                        </div>
